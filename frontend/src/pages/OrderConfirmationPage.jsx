...
const OrderConfirmationPage = () => {
  ...
  const isAdminViewingOtherUserOrder = 
    user?.role === 'admin' && 
    order?.userId?._id && 
    user?._id && 
  ...
  console.log('Order User Name:', order?.userId?.name);
  console.log('Is Admin viewing other user order:', isAdminViewingOtherUserOrder);
  console.log('=============');
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          {isAdminViewingOtherUserOrder ? (
            <>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">Detalhes do Pedido</h1>
              <p className="text-gray-600">
                Visualizando pedido do cliente: {order.userId?.name || 'N/A'}
              </p>
            </>
          ) : (
            <>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          {isAdminViewingOtherUserOrder ? (
            <Link to="/admin/orders" className="btn-primary w-full text-center">
              Voltar ao Gerenciamento de Pedidos
            </Link>
          ) : (
            <>
