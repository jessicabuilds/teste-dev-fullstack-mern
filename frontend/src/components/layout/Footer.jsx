    ...
    <footer className="bg-gray-900 text-gray-300 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-gray-500">Produtos</li>
              <li className="text-gray-500">Carrinho</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="text-gray-500">Smartphones</li>
              <li className="text-gray-500">Notebooks</li>
              <li className="text-gray-500">Acessórios</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-sm text-center">
          <p>Feito com 💙​ por Jéssica Alves</p>
        </div>
      </div>
    </footer>
  );
